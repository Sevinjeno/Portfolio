...
import logojeno from '../assets/logojeno.png'
const Navbar = () => {
      ...
      <div className="w-full flex justify-between items-center max-2-7xl mx-auto">
            <Link 
                ...
                onClick={()=>{
                  ...
                  <img src={logojeno} alt='logo' className='w-9 h-9 object-contain' />
                
                <p className='text-white text-[18px] font-bold cursor-pointer flex'>
                  Sevinjeno &nbsp;<span className='sm:block hidden'>| Web Developer</span>
                </p>
            </Link>
