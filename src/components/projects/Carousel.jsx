        ...
        <div className='overflow-hidden relative'>
          ...
          <div className='absolute inset-0 flex items-center justify-between p-4'>
            <button onClick={prev} className='p-1 rounded-full shadow bg-white/80 text-gray-800 hover:bg-white  btn_carousel'>
              <ChevronLeft className='btn-svg' size={40} />
            </button>
            <button onClick={next} className='p-1 rounded-full shadow bg-white/80 text-gray-800 hover:bg-white btn_carousel'>
              <ChevronRight  className='btn-svg' size={40}/>
            </button>
          </div>

            <div className="absolute bottom-4 right-0 left-0 bottom-carousel">
